...
import cz.muni.aphos.exceptions.IllegalCoordinateFormatException;
...
/**
 * The service for parsing uploaded csv file and calling dao methods
 * to persistem the parsed objects to the database.
 */
@Service
public class FileHandlingService {
     ...
     * @param uploadingUser user that uploaded the file
    ...
    /**
     * Parse csv part of the file (the rows after the initial data).
     *
     * @param schemaRow       the schema of the csv discovered during the initial data parsing
     ...
     *
     * @param file            the file
     * @param photoProperties empty PhotoProperties object to store the time of the photo in
     * @return the pair consisting of the schema of the csv part of the file and length of the header
     * @throws IOException the io exception if an IO error occurs
     */
    ...
    /**
     * Parse a row of csv data and persist it in the database.
     *
     * @param row             the row of csv data as a map of: column name -> column value in the row
     * @param photoProperties the photo properties object of the file
     ...
     * @throws ParseException in case of Unparsable coordinate format
     */
     ...
     * @param photoProperties  the primary key of the corresponding space object
     * @param uploadingUser    the uploading user
